...
export const advertiseItem = [
  ...
  },
  {
    id: uuidv4(),
    itemName: '',
    img: 'https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1689405596/Croma%20Assets/CMS/LP%20Page%20Banners/2023/Oneplus%20Nord/Without%20buds/HP_OneplusNord35G_12July2023_vaixuk.jpg?tr=w-2048',
  },
  {
    id: uuidv4(),
    itemName: '',
...
export const watchProducts = [
  ...
  },
  {
    ...
    price: 899,
    details:
      'TIMEWEAR Analog New Track Day Date Functioning Leather Strap Watch for Men',
    quantity: 1,
  },
  {
    id: uuidv4(),
...
export const mobileProducts = [
  {
    id: uuidv4(),
    image:
      'https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1683557701/Croma%20Assets/Communication/Mobiles/Images/267795_0_bvlmaa.png?tr=w-360',
    text: 'oppo',
    price: 18999.0,
    details: 'oppo A78 5G (8GB RAM, 128GB, Glowing Blue)',
    quantity: 1,
  },
  {
    id: uuidv4(),
    image:
      'https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1681133024/Croma%20Assets/Communication/Mobiles/Images/270432_ayeasp.png?tr=w-360',
    text: 'vivo',
    price: 32999.0,
    details: 'vivo V27 5G (8GB RAM, 128GB, Magic Blue)',
    quantity: 1,
  },
  {
    id: uuidv4(),
    image:
      'https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1662443638/Croma%20Assets/Communication/Mobiles/Images/251802_on6al4.png?tr=w-400',
    text: 'one plus',
    price: 17999.0,
    details: 'OnePlus Nord CE2 Lite 5G (6GB RAM, 128GB, Blue Tide)',
    quantity: 1,
  },
  {
    id: uuidv4(),
    image:
      'https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1680399706/Croma%20Assets/Communication/Mobiles/Images/252421_gp6qrh.png?tr=w-400',
    text: 'vivo',
    price: 37999.0,
    details:
      'OnePlus 10R 5G (12GB RAM, 256GB, Sierra Black) | With 150W SUPERVOOC Charging',
    quantity: 1,
  },
  {
    id: uuidv4(),
    image:
      'https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1662703724/Croma%20Assets/Communication/Mobiles/Images/261934_qgssvy.png?tr=w-400',
    text: 'vivo',
    price: 72990,
    details: 'Apple iPhone 14 (128GB, Blue)',
    quantity: 1,
  },
  {
    id: uuidv4(),
    image:
      'https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1662418914/Croma%20Assets/Communication/Mobiles/Images/230107_t40uo8.png?tr=w-400',
    text: 'apple',
    price: 41999.0,
...
const questions = [
  {
    ...
    answer: ` Contactless Delivery means that there will be no direct contact
   between customer and delivery rider. Meal will be placed in a
  pre-agreed location and avoid touching or close face to face
 contact.`,
  },
  {
    id: 2,
    question: 'How to do I avail contactless delivery?',
    answer: ` Please opt for ‘Contactless delivery’ while placing your order
            online (web/m-site/app). Sometimes, our rider will also get in touch
            with you to understand where the pizza needs to be placed.`,
  },
  {
    id: 3,
    question: 'Can I do Cash-on-delivery for contactless delivery?',
    answer: `  No, you cannot opt for cash-on-delivery. Since we are trying to make
  ...
  },
  {
    ...
    answer: `No, you don’t have to pay extra to avail the contactless delivery
  service.`,
  },
  {
    id: 5,
    question: 'Can I get all pizzas and other products at all stores?',
    answer: `The menu is displayed as per the availability of the menu items in
            the respective restaurant. In case certain menu items are not listed
            in the menu page, that restaurant is not serving those items. In
            case of non-availability of ordered product at a particular
            restaurant, the order will not be fulfilled. The restaurant will
